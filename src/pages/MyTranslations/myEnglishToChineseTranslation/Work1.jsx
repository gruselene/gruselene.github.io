...
const Work1 = () => {
  return (
    <div className="space-y-12">
      {/* Back Navigation */}
      <Link 
        to="/my-translations/myEnglishToChineseTranslation" 
      ...
      >
        <ArrowLeft size={16} />
        <span>Back to English to Chinese Translations</span>
      </Link>
      ...
      <section className="mystic-card p-8 md:p-12">
        <div className="prose prose-invert max-w-none font-serif">
          <div className="mb-8 p-6 border-l-2 border-gold-500/50 bg-mystic-900/30">
            <p className="text-mystic-200 italic">
              "Original English text will go here..."
            </p>
          </div>
          ...
          <p className="text-mystic-300 leading-relaxed mt-6">
            Add your translation content here. This is a placeholder for your English to Chinese translation work.
          </p>
        </div>
      </section>
    </div>
