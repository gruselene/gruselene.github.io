...
const Poem1 = () => {
  return (
    <div className="space-y-12">
      ...
      >
        <ArrowLeft size={16} />
        <span>Back to Metred Poems</span>
      </Link>
      ...
      <section className="mystic-card p-8 md:p-12">
        <div className="prose prose-invert max-w-none font-serif">
          <p className="text-mystic-300 leading-relaxed text-lg whitespace-pre-line">
            {`Your metred poem content goes here...

With rhythm and rhyme,
The verses flow in time,
A structured dance of words.

Add your metred poem text here.`}
          </p>
        </div>
      </section>
    </div>
