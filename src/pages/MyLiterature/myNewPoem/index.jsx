...
const MyNewPoem = () => {
  ...
  useEffect(() => {
    ...
    // 注册作品
    autoRegisterWork('literature', 'myNewPoem', {
      id: 'Poem1',
      title: 'Placeholder New Poem 1',
      excerpt: 'Your new poem content goes here...',
      date: '2024-04-27',
      category: 'Poetry',
  ...
  const category = getCategory('literature', 'myNewPoem');
          ...
          <article className="mystic-card group">
            ...
            {poem.title && (
              <h2 className="card-title">
                <Link to={`/my-literature/myNewPoem/${poem.id}`}>{poem.title}</Link>
              </h2>
            )}
            {poem.excerpt && (
