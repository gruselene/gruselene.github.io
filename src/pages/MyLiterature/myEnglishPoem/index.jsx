...
const MyEnglishPoem = () => {
  ...
  useEffect(() => {
    ...
    // 注册作品
    autoRegisterWork('literature', 'myEnglishPoem', {
      id: 'Poem1',
      title: 'Placeholder English Poem 1',
      excerpt: 'Your English poem content goes here...',
      date: '2024-04-27',
      category: 'Poetry',
  ...
  const category = getCategory('literature', 'myEnglishPoem');
          ...
          <article className="mystic-card group">
            ...
            {poem.title && (
              <h2 className="card-title">
                <Link to={`/my-literature/myEnglishPoem/${poem.id}`}>{poem.title}</Link>
              </h2>
            )}
            {poem.excerpt && (
